...
/**
 * <p>Java class for Actividades.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <pre>{@code
 * <simpleType name="Actividades">
...
public enum Actividades {
    ...
    public static Actividades fromValue(String v) {
        for (Actividades c: Actividades.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
